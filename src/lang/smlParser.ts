...
export class smlParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"program", "declaration", "valbind", "funbind", "pattern", "matchSml", 
		"mrule", "keypattern", "expression", "keyvalue", "label", "id", "variable", 
		"constant",
	];
		...
		try {
			...
			case smlParser.T__6:
				...
				case 1:
					...
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << smlParser.T__1) | (1 << smlParser.T__10) | (1 << smlParser.T__12) | (1 << smlParser.T__13) | (1 << smlParser.T__15) | (1 << smlParser.T__16) | (1 << smlParser.T__17) | (1 << smlParser.T__18) | (1 << smlParser.T__19) | (1 << smlParser.T__20) | (1 << smlParser.T__21) | (1 << smlParser.T__22) | (1 << smlParser.T__23) | (1 << smlParser.T__24) | (1 << smlParser.T__25) | (1 << smlParser.T__26) | (1 << smlParser.T__27) | (1 << smlParser.T__28) | (1 << smlParser.T__29) | (1 << smlParser.T__30))) !== 0) || _la === smlParser.INT || _la === smlParser.LETTER) {
						{
						this.state = 70;
						this.keypattern();
						}
		...
		try {
			...
			case 6:
				...
				case 1:
					...
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << smlParser.T__1) | (1 << smlParser.T__3) | (1 << smlParser.T__6) | (1 << smlParser.T__8) | (1 << smlParser.T__10) | (1 << smlParser.T__12) | (1 << smlParser.T__13) | (1 << smlParser.T__15) | (1 << smlParser.T__16) | (1 << smlParser.T__17) | (1 << smlParser.T__18) | (1 << smlParser.T__19) | (1 << smlParser.T__20) | (1 << smlParser.T__21) | (1 << smlParser.T__22) | (1 << smlParser.T__23) | (1 << smlParser.T__24) | (1 << smlParser.T__25) | (1 << smlParser.T__26) | (1 << smlParser.T__27) | (1 << smlParser.T__28) | (1 << smlParser.T__29) | (1 << smlParser.T__30))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (smlParser.CHAR - 32)) | (1 << (smlParser.STR - 32)) | (1 << (smlParser.BOOL - 32)) | (1 << (smlParser.REAL - 32)) | (1 << (smlParser.INT - 32)) | (1 << (smlParser.FN - 32)) | (1 << (smlParser.IF - 32)))) !== 0) || _la === smlParser.LETTER) {
						{
						this.state = 163;
						this.expression(0);
						}
