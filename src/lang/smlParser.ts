                ...
                case 1:
                  {
                    ...
                    this.state = 104
                    ;(_localctx as ExpressionApplicationPrefixContext)._operand =
                      this.expression(13)
                  }
                  break
                ...
                case 2:
                  {
                    ...
                    if (!(_la === smlParser.T__4 || _la === smlParser.T__5)) {
                      ;(_localctx as ExpressionApplicationInfixContext)._operator =
                ...
                case 4:
                  {
                    ...
                    this.state = 112
                    ;(_localctx as ExpressionApplicationInfixContext)._operator = this.match(
                      smlParser.T__9
                    )
                    this.state = 113
...
export class ExpressionApplicationInfixContext extends ExpressionContext {
  ...
  public ANDALSO(): TerminalNode | undefined {
    return this.tryGetToken(smlParser.ANDALSO, 0)
  }
  public ORELSE(): TerminalNode | undefined {
    return this.tryGetToken(smlParser.ORELSE, 0)
  }
  constructor(ctx: ExpressionContext) {
    super(ctx.parent, ctx.invokingState)
    this.copyFrom(ctx)
