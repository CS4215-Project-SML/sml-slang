...
export class SmlParser extends Parser {
	...
	public expression(_p?: number): ExpressionContext {
		...
		this.enterRecursionRule(_localctx, 2, SmlParser.RULE_expression, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 15;
						(_localctx as PowerContext)._operator = this.match(SmlParser.POW);
						this.state = 16;
					...
					case 2:
						...
						this.state = 18;
						(_localctx as MultiplicationContext)._operator = this.match(SmlParser.MUL);
						this.state = 19;
					...
					case 3:
						...
						this.state = 21;
						(_localctx as DivisionContext)._operator = this.match(SmlParser.DIV);
						this.state = 22;
					...
					case 4:
						...
						this.state = 24;
						(_localctx as AdditionContext)._operator = this.match(SmlParser.ADD);
						this.state = 25;
					...
					case 5:
						...
						this.state = 27;
						(_localctx as SubtractionContext)._operator = this.match(SmlParser.SUB);
						this.state = 28;
...
export class PowerContext extends ExpressionContext {
	...
	public POW(): TerminalNode { return this.getToken(SmlParser.POW, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class MultiplicationContext extends ExpressionContext {
	...
	public MUL(): TerminalNode { return this.getToken(SmlParser.MUL, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class DivisionContext extends ExpressionContext {
	...
	public DIV(): TerminalNode { return this.getToken(SmlParser.DIV, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class AdditionContext extends ExpressionContext {
	...
	public ADD(): TerminalNode { return this.getToken(SmlParser.ADD, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class SubtractionContext extends ExpressionContext {
	...
	public SUB(): TerminalNode { return this.getToken(SmlParser.SUB, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
